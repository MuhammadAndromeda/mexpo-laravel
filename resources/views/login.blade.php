...
<body class="overflow-x-hidden">
    ...
    <main class="w-full h-max overflow-x-hidden">
        <section class="w-full h-screen bg-white p-4 flex justify-center items-center">
            <div class="w-full h-full gap-4 flex justify-between items-center">
                <aside class="w-1/2 h-full px-8 pt-8 pb-16 bg-login-gradient rounded-3xl flex flex-col justify-between items-start">
                ...
                <div class="w-1/2 h-full px-20 gap-10 flex flex-col justify-center items-start">
                    <header class="w-full gap-2 flex flex-col justify-center items-center">
                        ...
                        <div class="w-full text-indigo-950 gap-3 flex flex-col justify-center items-start">
                            <h1 class="text-3xl font-black capitalize">Login to your account</h1>
                            <p class="text-sm font-medium capitalize">access your task, notes and project anytime, anywhere - and keep everything flowing in one place</p>
                        </div>
                    </header>

                    <div class="w-full gap-8 flex flex-col justify-center items-center">
                        <form method="get" class="w-full gap-6 flex flex-col justify-center items-center">
                            ...
                            <button type="submit" class="w-full py-3 rounded-lg border-2 border-blue-700 bg-blue-700 shadow-lg shadow-blue-900/60 hover:bg-transparent text-white hover:text-blue-700 text-center text-base font-medium capitalize cursor-pointer transition-all duration-300">login</button>
                        </form>
